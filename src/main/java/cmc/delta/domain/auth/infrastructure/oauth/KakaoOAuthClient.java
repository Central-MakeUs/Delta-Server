    ...
    public OAuthToken exchangeCode(String code) {
        ...
        try {
            ResponseEntity<KakaoTokenResponse> response =
                    kakaoRestTemplate.postForEntity(TOKEN_URL, new HttpEntity<>(form, headers), KakaoTokenResponse.class);
    ...
    public OAuthProfile fetchProfile(String providerAccessToken) {
        ...
        try {
            ResponseEntity<KakaoUserResponse> response =
                    kakaoRestTemplate.exchange(USER_URL, HttpMethod.GET, new HttpEntity<>(headers), KakaoUserResponse.class);
